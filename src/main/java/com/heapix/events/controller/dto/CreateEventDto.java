...
public class CreateEventDto {
    ...
    public CreateEventDto(@NotNull @NotEmpty @Size(min = 4, max = 50) String firstName, @NotNull @NotEmpty Date date, @NotNull @NotEmpty String location, @NotNull @NotEmpty String info, @NotNull @NotEmpty int price, int minNumberOfRegistrations, int maxNumberOfRegistrations) {
